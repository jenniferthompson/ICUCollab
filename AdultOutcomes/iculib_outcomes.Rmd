...
demog$elig_hosplos <- rowSums(
  is.na(demog[, c("id", logmods_covars_base, "hosp_los_7", "hosp_dc_7")])
) == 0 & (!is.na(demog$icu_days) & demog$icu_days > 0)
demog$elig_icudeath <- rowSums(
  is.na(demog[, c("id", logmods_covars_base, "icu_los_7", "icu_death_7")])
) == 0 & (!is.na(demog$icu_days) & demog$icu_days > 0)
