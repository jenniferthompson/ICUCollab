...
ggsave(
  filename = "missing_plot.tiff",
  plot = miss_plot,
  device = "tiff",
  path = "pubfigures/tiff",
  height = 7, width = 5, dpi = png_dpi
)
...
ggsave(
  filename = "inicu_plot_three_horiz.eps",
  plot = inicu_plot_three_horiz,
  device = cairo_ps,
  path = "pubfigures/eps",
  height = 3, width = 6.5, dpi = png_dpi
...
ggsave(
  filename = "inicu_plot_three_horiz.tiff",
  plot = inicu_plot_three_horiz,
  device = "tiff",
  path = "pubfigures/tiff",
  height = 3, width = 6.5, dpi = png_dpi
...
ggsave(
  filename = "inicu_plot_three_vert.eps",
  plot = inicu_plot_three_vert,
  device = cairo_ps,
  path = "pubfigures/eps",
  height = 6, width = 4.5, dpi = png_dpi
...
ggsave(
  filename = "inicu_plot_three_vert.tiff",
  plot = inicu_plot_three_vert,
  device = "tiff",
  path = "pubfigures/tiff",
  height = 6, width = 4.5, dpi = png_dpi
...
inicu_singleplot <- function(out_full, out_title, ybreaks = 0.05){
  ...
  ggsave(
    filename = sprintf("inicu_plot_%s.eps", out_title),
    plot = icuplot,
    device = cairo_ps,
    path = "pubfigures/eps",
    height = 5, width = 6, dpi = png_dpi
  ...
  ggsave(
    filename = sprintf("inicu_plot_%s.tiff", out_title),
    plot = icuplot,
    device = "tiff",
    path = "pubfigures/tiff",
    height = 5, width = 6, dpi = png_dpi
...
ggsave(
  filename = "tte_plot_three_horiz.eps",
  plot = tte_plot_three_horiz +
    scale_x_discrete(name = "Proportion of ABCDEF Bundle\nElements Performed") +
    scale_y_continuous(name = "Adjusted Hazard Ratio (95% Confidence Interval)",
                       limits = c(0, 2.05),
...
ggsave(
  filename = "tte_plot_three_horiz.tiff",
  plot = tte_plot_three_horiz +
    scale_x_discrete(name = "Proportion of ABCDEF Bundle\nElements Performed") +
    scale_y_continuous(name = "Adjusted Hazard Ratio (95% Confidence Interval)",
                       limits = c(0, 2.05),
...
ggsave(
  filename = "tte_plot_three_vert.eps",
  plot = tte_plot_three_vert +
    scale_x_discrete(name = "Proportion of ABCDEF Bundle Elements Performed") +
    scale_y_continuous(name = "Adjusted Hazard Ratio (95% Confidence Interval)",
                       limits = c(0, 2.05),
...
ggsave(
  filename = "tte_plot_three_vert.tiff",
  plot = tte_plot_three_vert +
    scale_x_discrete(name = "Proportion of ABCDEF Bundle Elements Performed") +
    scale_y_continuous(name = "Adjusted Hazard Ratio (95% Confidence Interval)",
                       limits = c(0, 2.05),
...
tte_singleplot <- function(out_full, out_title, xbreaks){
  ...
  ggsave(
    filename = sprintf("tte_plot_%s.eps", out_title),
    plot = tteplot,
    device = cairo_ps,
    path = "pubfigures/eps",
    height = 5, width = 6, dpi = png_dpi
  ...
  ggsave(
    filename = sprintf("tte_plot_%s.tiff", out_title),
    plot = tteplot,
    device = "tiff",
    path = "pubfigures/tiff",
    height = 5, width = 6, dpi = png_dpi
...
ggsave(
  filename = "icusummary_plot_all_horiz.eps",
  plot = icusummary_plot_all +
    facet_wrap(~ outcome, scales = "free_y", nrow = 1) +
    scale_x_continuous(
      name = "Percent of Eligible ABCDEF Bundle Elements Performed",
...
ggsave(
  filename = "icusummary_plot_all_horiz.tiff",
  plot = icusummary_plot_all +
    facet_wrap(~ outcome, scales = "free_y", nrow = 1) +
    scale_x_continuous(
      name = "Percent of Eligible ABCDEF Bundle Elements Performed",
...
ggsave(
  filename = "icusummary_plot_all_vert.eps",
  plot = icusummary_plot_all +
    facet_wrap(~ outcome, scales = "free_y", ncol = 1) +
    scale_x_continuous(
      name = "Percent of Eligible ABCDEF Bundle\nElements Performed",
...
ggsave(
  filename = "icusummary_plot_all_vert.tiff",
  plot = icusummary_plot_all +
    facet_wrap(~ outcome, scales = "free_y", ncol = 1) +
    scale_x_continuous(
      name = "Percent of Eligible ABCDEF Bundle\nElements Performed",
...
icusummary_singleplot <- function(out_full, out_title, ybreaks = 0.05){
  ...
  ggsave(
    filename = sprintf("icusummary_plot_%s.eps", out_title),
    plot = icuplot,
    device = cairo_ps,
    path = "pubfigures/eps",
    height = 5, width = 6, dpi = png_dpi
    ...
    ggsave(
    filename = sprintf("icusummary_plot_%s.tiff", out_title),
    plot = icuplot,
    device = "tiff",
    path = "pubfigures/tiff",
    height = 5, width = 6, dpi = png_dpi
