...
It is important to note that because most Collaborative sites were only able to collect one week of data, these results only reflect deaths within the first 7 days after ICU admission. ABCDEF Bundle compliance and performance may have different associations with mortality when longer hospitalizations are able to be more included in more detail.
