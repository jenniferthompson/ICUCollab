...
pdf(file = "pubfigures/inicu_plot_mvonly.pdf", height = 5, width = 6)
inicu_plot_mvonly
dev.off()

```

## Supplement Figure 1: Hazard Ratios for Performance vs Time-to-Event Outcomes
