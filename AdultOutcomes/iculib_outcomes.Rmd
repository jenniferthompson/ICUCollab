...
correlation among days from the same patient. For each outcome, we will have
four different models using the following ABCDEF-related exposures:
...
logmods_covars_base <- c("age_cat_mod", "race_cat_mod", "hisp_cat_mod", "bmi",
                         "mob_preadmit", "home_preadmit", "primary_admit",
                         "icu_type_comb")
logmods_covars_daily <- c("comfort_care_icu", "on_sedation_icu_f",
                          "rcvd_benzo_icu", "rcvd_opioid_icu",
                          "rcvd_propofol_icu", "rcvd_dex_icu",
                          "rcvd_antipsyc_icu", "on_mv_icu_f", "coma_icu")
