...
\clearpage
<<printcompperffigs, results = 'asis', fig.cap = 'Compliance and Performance Over Time: Elements B and E', fig.height = 5.5, fig.width = 10.5, fig.pos = '!h', fig.align = 'center'>>=
plot.compperf

@

\clearpage
<<printcompliancefigs_overall, results = 'asis', fig.cap = 'ABCDEF Bundle Compliance and Performance Over Time: Total', fig.height = 7, fig.width = 10.5, fig.pos = '!h', fig.align = 'center'>>=
...
\clearpage
<<printelementfigs_overall, results = 'asis', fig.cap = 'ABCDEF Bundle Elements Compliance and Performance Over Time: Total', fig.height = 7, fig.width = 10.5, fig.pos = '!h', fig.align = 'center'>>=
