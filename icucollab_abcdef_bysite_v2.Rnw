...
latex(compliance.table, file = '',
      ...
      rgroup = c('',
                 'A: Assess... pain*',
                 'B: Both SAT \\& SBT',
                 'C: Choice analgesia/sedation',
                 'D: Delirium - assess...**',
                 'E: Early mobility \\& exercise',
                 'F: Family engagement***'),
      n.rgroup = c(1, 2, 8, 2, 2, 2, 2),
      col.just = rep('r', ncol(compliance.table)),
      insert.bottom = '\\emph{Note: All data are reported as frequences and percentages unless otherwise noted. SAT = spontaneous awakening trial; SBT = spontaneous breathing trial.\\\\ **Full term is "Assess, prevent, and manage pain."\\\\ ***Full term is "Delirium - assess, prevent, and manage pain."\\\\ ****Full term is "Family engagement and empowerment."}')
...
multiplot(plot.comp.d, plot.comp.d.ref, box.asmts.d,
          layout = matrix(c(1, 1, 3,
                            2, 2, 3),
                          byrow = TRUE, nrow = 2))
