...
ggplot.prop <-
  ...
  if(!is.null(facet.var)){
    prop.plot <- prop.plot + facet_wrap(~ facetvar)
  }
...
my.print.summaryM(comp.all.ac,
                  ...
                  caption.lot = 'Description of Compliance, All ICU Days',
...
<<printfiguresa, results = 'asis', fig.cap = 'A: Assess and Manage Pain', fig.width = 7.5, fig.height = 4.25, fig.pos = '!h', fig.align = 'center'>>=
...
<<printfiguresb, results = 'asis', fig.cap = 'B: Both SAT and SBT', fig.width = 7.5, fig.height = 4.25, fig.pos = '!h', fig.align = 'center'>>=
...
<<printfiguresc, results = 'asis', fig.cap = 'C: Choice of Sedation \\& Analgesia', fig.width = 7.5, fig.height = 4.25, fig.pos = '!h', fig.align = 'center'>>=
...
d.comp.plot <- ggplot.prop(var = 'd.comp.overall',
                           axis.text.size = 8,
                           title.string = 'D, Overall: >=6 Total Delirium Assessments')
...
<<printfiguresd, results = 'asis', fig.cap = 'D: Delirium: Assess, Prevent and Manage', fig.width = 7.5, fig.height = 4.25, fig.pos = '!h', fig.align = 'center'>>=
...
<<printfiguresef, results = 'asis', fig.cap = 'E and F: Exercise/Mobility and Family Participation', fig.width = 7.5, fig.height = 4.25, fig.pos = '!h', fig.align = 'center'>>=
