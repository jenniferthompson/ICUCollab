...
Table \ref{table:meds} summarizes drug doses \textbf{per 24 hours} for benzodiazepines and opioids.
...
latex(meds.table, file = '',
      title = '',
      caption = 'Daily Medication Use. Doses are summarized by {\\scriptsize 25th} 50th {\\scriptsize 75th} percentiles',
      digits = 2,
      prmsd = FALSE,
      prn = FALSE,
      prN = FALSE,
