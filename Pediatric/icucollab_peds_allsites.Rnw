...
Tables \ref{table:medsb6} and \ref{table:medsb12} summarize drug doses
...
label(compliance$benzo.total.eo) <-
...
latex(meds.table.b6, file = '',
      ...
      insert.bottom = "\\emph{* `Benzodiazepine recorded' indicates that a recorded dose was available for at least one of lorazepam and/or midazolam. `Opioid recorded' indicates that a recorded dose was available for at least one of morphine, hydromorphone, and/or fentanyl.}")
