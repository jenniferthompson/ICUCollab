...
all.perfpct <- list(pctdays.pain.threshold, pctdays.had.sat,
...
all.perfdays <- list(days.pain.threshold, days.had.sat, days.had.weaning,
                     days.sbt, days.sbt.protocol, days.anxio.spec,
                     days.del.present, days.exer, days.exer.protocol,
                     days.familyinter)

all.infodays <- list(days.painthreshold.info, days.sat.info, days.weaning.info,
...
meds.table <- summaryM(has.benzo + benzo.total + loraz.scaled + midaz.scaled +
                         clonaz.scaled + diaz.scaled + has.opioid +
                         opioid.total + morph.scaled + hydromorph.scaled +
                         fent.scaled ~ month.cat,
                       data = compliance)

meds.table.b6 <- summaryM(has.benzo + benzo.total + loraz.scaled +
                            midaz.scaled + clonaz.scaled + diaz.scaled +
                            has.opioid + opioid.total + morph.scaled +
                            hydromorph.scaled + fent.scaled ~ month.cat,
                          data = subset(compliance,
                                        month.cat %in% c('Baseline',
                                                         paste('Imp.', 1:6))))

meds.table.b12 <- summaryM(has.benzo + benzo.total + loraz.scaled +
                             midaz.scaled + clonaz.scaled + diaz.scaled +
                             has.opioid + opioid.total + morph.scaled +
                             hydromorph.scaled + fent.scaled ~ month.cat,
                           data = subset(compliance,
