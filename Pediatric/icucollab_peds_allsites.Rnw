...
\clearpage
<<vis_demog_1_agg, results = 'asis', fig.height=10, fig.width = 7.5>>=
...
\clearpage
<<vis_demog_2_agg, results = 'asis', fig.height=6, fig.width = 7.5>>=
...
<<vis_outcomes_1_agg, results = 'asis', fig.height=6, fig.width = 7.5>>=
multiplot(desc_plots$fss, desc_plots$popc,
          layout = matrix(c(1, 2), ncol = 1))

@

<<vis_outcomes_2_agg, results = 'asis', fig.height=3, fig.width = 7.5>>=
multiplot(desc_plots$ever.vent, desc_plots$ventdays,
          layout = matrix(c(1, 2), nrow = 1, byrow = TRUE))

@

<<vis_outcomes_3_agg, results = 'asis', fig.height=3, fig.width = 7.5>>=
...
<<perfcharta_agg, results = 'asis', fig.height = 7, fig.width = 10, fig.align = 'center'>>=
perf.charts[[1]]
@

<<perfchartb_sat_agg, results = 'asis', fig.height = 6, fig.width = 10, fig.align = 'center'>>=
multiplot(perf.charts[[2]], perf.charts[[3]], layout = matrix(1:2, nrow = 1))
@

<<perfchartb_sbt_agg, results = 'asis', fig.height = 6, fig.width = 10, fig.align = 'center'>>=
multiplot(perf.charts[[4]], perf.charts[[5]], layout = matrix(1:2, nrow = 1))
@

<<perfchartc_agg, results = 'asis', fig.height = 7, fig.width = 10, fig.align = 'center'>>=
perf.charts[[6]]
@

<<perfchartd_agg, results = 'asis', fig.height = 7, fig.width = 10, fig.align = 'center'>>=
perf.charts[[7]]
@

<<perfcharte_agg, results = 'asis', fig.height = 6, fig.width = 10, fig.align = 'center'>>=
multiplot(perf.charts[[8]], perf.charts[[9]], layout = matrix(1:2, nrow = 1))
@

<<perfchartf_agg, results = 'asis', fig.height = 7, fig.width = 10, fig.align = 'center'>>=
perf.charts[[10]]
@
...
The following sites are \textbf{included} in Tables \ref{table:meddoses1}-\ref{table:meddoses2}: Johns Hopkins; Seattle; St Louis; UC Davis. \textbf{If no dose is entered in the database, we assume this indicates that no drug was given, and that day/drug is assigned a dose of 0.}
...
\clearpage
<<print_benzo_runcharts_agg, results = "asis", fig.width = 10, fig.height = 7.5, fig.align = "center">>=
...
\clearpage
<<print_opioid_runcharts_agg, results = "asis", fig.width = 10, fig.height = 7.5, fig.align = "center">>=
