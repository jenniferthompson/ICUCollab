...
plot.comp.b.sat <-
  plot.compliance('pct.comp.b.sat', 'SAT Protocol Compliance\nOut of All ICU Days on Sedation',
    ...
    theme(plot.title = element_text(hjust = 0, face = 'bold'))
plot.perf.b.sat <-
  plot.compliance('pct.perf.b.sat', 'SAT Performance\nOut of All ICU Days on Sedation',
                  put.legend = 'top', refline.size = 1) +
    labs(title = 'B: Both SAT + SBT') +
    theme(plot.title = element_text(hjust = 0, face = 'bold'))
plot.comp.b.sbt <-
  ...
  labs(title = '')
plot.perf.b.sbt <-
  plot.compliance('pct.perf.b.sbt', 'SBT Performance\nOut of All ICU Days on MV',
                  put.legend = 'top', refline.size = 1) +
  labs(title = '')
...
plot.comp.e <- plot.compliance('pct.comp.e', 'Early Mobility Compliance\nOut of All ICU Days',
  ...
  theme(plot.title = element_text(hjust = 0, face = 'bold'))
plot.perf.e <- plot.compliance('pct.perf.e', 'Early Mobility Performance\nOut of All ICU Days',
                               put.legend = 'top', refline.size = 1) +
  labs(title = 'E: Early mobility and exercise') +
  theme(plot.title = element_text(hjust = 0, face = 'bold'))
...
<<printcompliancefigs1, results = 'asis', fig.cap = 'ABCDEF Bundle Compliance and Performance Over Time: Elements A \\& B', fig.height = 8, fig.width = 10.5, fig.pos = '!h', fig.align = 'center'>>=
multiplot(plot.comp.a, box.asmts.a,
          plot.comp.region.a, box.asmts.region.a,
          plot.perf.b.sat, plot.perf.b.sbt, plot.perf.b.satsbt,
...
<<printcompliancefigs2, results = 'asis', fig.cap = 'ABCDEF Bundle Compliance and Performance Over Time: Elements C \\& D', fig.height = 8, fig.width = 10.5, fig.pos = '!h', fig.align = 'center'>>=
...
<<printcompliancefigs3, results = 'asis', fig.cap = 'ABCDEF Bundle Compliance and Performance Over Time: Elements E \\& F', fig.height = 4.5, fig.width = 10.5, fig.pos = 't'>>=
multiplot(plot.perf.e, plot.comp.f,
          plot.perf.region.e, plot.comp.region.f,
