...
rownames(compliance.table.trans) <- c('Days compliance tracked, inc. last',
                                      # 'Pain assessment compliance',
                                      # 'Pain asmts/day (median/IQR)',
                                      'Days on sedatives',
                                      'SAT protocol compliance',
...
box.asmts.a <- plot.assessments(asmtvar = 'n.painassess.icu') +
  scale_y_continuous(name = 'Pain Assessments in 24hOn All ICU Days',
...
the patient is in the ICU <24 hours, cannot be included in describing compliance for those elements.
...
latex(compliance.table.trans, file = '',
      ...
      insert.bottom = '\\emph{Note: All data are reported as frequences and percentages unless otherwise noted. SAT = spontaneous awakening trial; SBT = spontaneous breathing trial.\\\\ **Full term is "Family engagement and empowerment."}')
