...
rownames(compliance.table) <- c('Days compliance was tracked',
                                ...
                                'SAT performed at all',
                                'Days on mechanical ventilation',
                                'SBT protocol compliance',
                                'SBT performed at all',
                                'Days with SAT + SBT',
                                ...
                                'Early mobility performed at all',
                                'Days family present',
...
plot.comp.b.sbt <-
  plot.compliance('pct.comp.b.sbt', 'SBT Protocol Compliance\nOut of All ICU Days on MV',
                  put.legend = 'top', refline.size = 1) +
  labs(title = '')
plot.comp.b.satsbt <- plot.compliance('pct.comp.b.satsbt',
                                      'SAT Prior to SBT\nOut of All Days with SAT+SBT',
                                      put.legend = 'bottom', refline.size = 1) +
  labs(title = '')
plot.comp.c <- plot.compliance('pct.comp.c',
                               'Sedation Asmt Compliance\nOut of All ICU Days on Sedation') +
...
box.asmts.a <- plot.assessments(asmtvar = 'n.painassess.icu') +
  scale_y_continuous(name = 'Pain Assessments in 24h\nOn All ICU Days',
