...
plot.compliance <- function(compvar, ytitle, put.legend = c('bottom', 'top')){
  ...
  ggplot(data = comp.summary,
    ...
    geom_vline(xintercept = 1.5, colour = 'white', size = 1.5) +
    geom_line() +
    geom_point() +
...
plot.comp.b.sat <-
  plot.compliance('pct.comp.b.sat', 'SAT Protocol Compliance', put.legend = 'top') +
    labs(title = 'B: Both SAT + SBT') +
    theme(plot.title = element_text(hjust = 0, face = 'bold'))
plot.comp.b.sbt <-
  plot.compliance('pct.comp.b.sbt', 'SBT Protocol Compliance', put.legend = 'top') +
  labs(title = '')
plot.comp.b.satsbt <- plot.compliance('pct.comp.b.satsbt', 'SAT Prior to SBT', put.legend = 'top') +
  labs(title = '')
...
plot.comp.d <- plot.compliance('pct.comp.d', 'Delirium Asmt Compliance') +
  ...
  theme(plot.title = element_text(hjust = 0, face = 'bold'))
plot.comp.e <- plot.compliance('pct.comp.e', 'Early Mobility Compliance', put.legend = 'top') +
  labs(title = 'E: Early mobility and exercise') +
  theme(plot.title = element_text(hjust = 0, face = 'bold'))
plot.comp.f <- plot.compliance('pct.comp.f', 'Family Engagement Compliance') +
...
box.asmts.a <- ggplot(data = compliance.plotdata, aes(x = data.month, y = n.painassess.icu)) +
  geom_boxplot(fill = NA, colour = 'navy') +
  scale_x_discrete(name = '') +
